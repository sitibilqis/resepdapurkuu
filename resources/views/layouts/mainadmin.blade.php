...
<html lang="en">
  ...
  <style>
    * {
    ...
    #carouselCategory .carousel-control-prev /*, .carousel-indicators */ {
      filter: invert(100%);
    }
      ...
      <!-- Navbar -->
        <nav class="navbar navbar-expand-lg" style="background-color: #E31F1F;">
          <div class="container-fluid">
            <img src="{{ asset('build/assets/img/resepdapurku.png') }}" class="mx-4" width="20" alt="">
          ...
          <div class="container p-4">
            <div class="row">
              <div class="col-lg-6 col-md-12 mb-4 mb-md-0 max text-dark">
                  <h6>TENTANG KAMI</h6>
                  <p class="m-0 col-6">Kami menyediakan resep yang dibuat dengan bahan-bahan segar dan berkualitas tinggi.</p>
              </div>
          ...
          <div class="container p-4">
            <div class="row">
              <div class="col-md-5 mb-1 mb-md-0">
                <div>
                    <a href="https://facebook.com"><img src="{{ asset('build/assets/img/icons8-facebook-f-48.png') }}" height="20" alt=""></a>
                    <a href="https://instagram.com"><img src="{{ asset('build/assets/img/icons8-instagram-48.png') }}" height="20" alt=""></a>
                    <a href="https://twitter.com"><img src="{{ asset('build/assets/img/icons8-twitter-64.png') }}" height="20" alt=""></a>
                    <a href="https://youtube.com"><img src="{{ asset('build/assets/img/icons8-youtube-60.png') }}" height="20" alt=""></a>                
                </div>
              </div>
